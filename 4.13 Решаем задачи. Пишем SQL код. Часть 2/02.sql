...
Напишите запрос, выводящий количество использования каждой реакции в личных сообщениях. Сколько раз встречается каждый reaction_id в таблице private_message_reactions? Выборку отсортировать по убыванию количества строк.
